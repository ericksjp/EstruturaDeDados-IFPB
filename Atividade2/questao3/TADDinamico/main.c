...
void interface_principal(Lista* l, char csvLink[]);
...
void interface_cadastro(Lista** l);
void interface_remocao (Lista** l);
void interface_busca(Lista* l);
void interface_ordenacao(Lista** l);
