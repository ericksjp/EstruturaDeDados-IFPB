...
void interface_principal(ListaFuncionario* l, char csvLink[]);

int main() {
    ListaFuncionario lista = cria_lista(50);
    lerDoArquivo(&lista, arquivoCSV);
    interface_principal(&lista, arquivoCSV);
    return 0;
}

// -------------------------------------------------------------------------------------------------------------------------------

void interface_cadastro(ListaFuncionario* l);
void interface_remocao (ListaFuncionario* l);
void interface_busca(ListaFuncionario l);
void interface_ordenacao(ListaFuncionario* l);
